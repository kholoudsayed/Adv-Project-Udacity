...
public class MainActivityTest {
    ...
    public void startActivity_withIntent() {
        ...
        intended(hasComponent(hasClassName(MainActivityAnd.class.getName())));
        intended(hasExtra(equalTo("jokeTest"), notNullValue()));

        onView(allOf(withId(R.id.txtand))).check(matches(not(withText(""))));
    }
